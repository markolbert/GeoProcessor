...
namespace J4JSoftware.KMLProcessor
{
    public class Distance
    {
        ...
        public static bool operator >( Distance a, Distance b ) => a.OriginalValue > b.GetValue( a.Unit );
        public static bool operator <( Distance a, Distance b ) => a.OriginalValue < b.GetValue( a.Unit );
        public static bool operator ==( Distance a, Distance b ) => Math.Abs( a.OriginalValue - b.GetValue( a.Unit ) ) < 1E-5;
        ...
        public static Distance operator *( Distance x, double multiplier ) =>
            new Distance( x.Unit, x.OriginalValue * multiplier );

        public static Distance operator *(double multiplier, Distance x) =>
            new Distance(x.Unit, x.OriginalValue * multiplier);

        public static Distance operator /( Distance x, double divisor ) =>
            new Distance( x.Unit, x.OriginalValue / divisor );

        public static Distance operator +( Distance a, Distance b ) =>
            new Distance( a.Unit, a.OriginalValue + b.GetValue( a.Unit ) );

        public static Distance operator -(Distance a, Distance b) =>
            new Distance(a.Unit, a.OriginalValue - b.GetValue(a.Unit));

        public override int GetHashCode() => HashCode.Combine(Unit, OriginalValue);
